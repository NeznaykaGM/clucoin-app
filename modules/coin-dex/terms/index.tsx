...
// views
import { Wrapper, Title, SubTitle } from './views';
...
const Terms = () => {
  return (
    <Wrapper>
      ...
      <p>
        Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to COIN DeXCoin Inc.{' '}
      </p>
      ...
      <p>
        Third-party Social Media Service means any services or content (inCOIN DeXding data, information, products or
        services) provided by a third-party that may be displayed, inCOIN DeXded or made available by the Service.
      </p>
      <p> Website refers to COIN DeXCoin, accessible from https://COIN DeXcoin.com</p>
      <p>
      ...
      <p>
        ...
        whatsoever, inCOIN DeXding without limitation if You breach these Terms and Conditions. Upon termination, Your
      ...
      <p>
        ...
        under any provision of this Terms and Your exCOIN DeXsive remedy for all of the foregoing shall be limited to
        the amount actually paid by You through the Service or 100 USD if You haven't purchased anything through the
        Service.
      </p>
      <p>
        To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be liable for
        any special, incidental, indirect, or consequential damages whatsoever (inCOIN DeXding, but not limited to,
        ...
        this Terms), even if the Company or any supplier has been advised of the possibility of such damages and even if
        the remedy fails of its essential purpose.
      </p>
      <p>
        Some states do not allow the exCOIN DeXsion of implied warranties or limitation of liability for incidental or
      ...
      <p>
        ...
        whether express, implied, statutory or otherwise, with respect to the Service, inCOIN DeXding all implied
        ...
        foregoing, the Company provides no warranty or undertaking, and makes no representation of any kind that the
      ...
      <p>
        ...
        information, content, and materials or products inCOIN DeXded thereon; (ii) that the Service will be
      ...
      <p>
        Some jurisdictions do not allow the exCOIN DeXsion of certain types of warranties or limitations on applicable
        statutory rights of a consumer, so some or all of the above exCOIN DeXsions and limitations may not apply to
        You. But in such a case the exCOIN DeXsions and limitations set forth in this section shall be applied to the
        greatest extent enforceable under applicable law.
      </p>
      <SubTitle>Governing Law</SubTitle>
      <p>
        The laws of the Country, exCOIN DeXding its conflicts of law rules, shall govern this Terms and Your use of the
      ...
      <p>
        ...
        effect. What constitutes a material change will be determined at Our sole discretion. By continuing to access or
